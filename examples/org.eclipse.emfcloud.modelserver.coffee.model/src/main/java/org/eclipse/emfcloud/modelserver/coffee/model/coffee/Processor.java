 ...
 *   <li>{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getNumberOfCores <em>Number Of Cores</em>}</li>
 *   <li>{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getSocketconnectorType <em>Socketconnector Type</em>}</li>
 *   <li>{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getThermalDesignPower <em>Thermal Design Power</em>}</li>
 *   <li>{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getManufactoringProcess <em>Manufactoring Process</em>}</li>
 * </ul>
 *
...
public interface Processor extends EObject
{
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getVendor <em>Vendor</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getClockSpeed <em>Clock Speed</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setClockSpeed(String value);
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getNumberOfCores <em>Number Of Cores</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setNumberOfCores(String value);

  /**
   * Returns the value of the '<em><b>Socketconnector Type</b></em>' attribute.
   * The literals are from the enumeration {@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.SocketConnectorType}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getSocketconnectorType <em>Socketconnector Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setThermalDesignPower(String)
   * @see org.eclipse.emfcloud.modelserver.coffee.model.coffee.CoffeePackage#getProcessor_ThermalDesignPower()
   * @model
   * @generated
   */
  String getThermalDesignPower();

  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getThermalDesignPower <em>Thermal Design Power</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setThermalDesignPower(String value);

  /**
   * Returns the value of the '<em><b>Manufactoring Process</b></em>' attribute.
   * The literals are from the enumeration {@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.ManufactoringProcess}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link org.eclipse.emfcloud.modelserver.coffee.model.coffee.Processor#getManufactoringProcess <em>Manufactoring Process</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
